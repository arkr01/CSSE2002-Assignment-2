...
public abstract class DemoSensor implements TimedItem {
    ...
    /** Constant value used by Java's hashCode methods to form unique code. */
    private static final int HASH_CODE_SCALE = 31;
     ...
     * sensor.
     * <p>For two sensors to be equal, the must have: </p>
     *
     * <ul>
    ...
    public boolean equals(Object obj) {
        if (obj != null && obj.getClass() == this.getClass()) {
            // Can now cast obj (since classes match) and call the
            // respective methods
            DemoSensor demoSensor = (DemoSensor) obj;
            if (this.getThreshold() == demoSensor.getThreshold()) {
                return Arrays.equals(this.data, demoSensor.data);
            }
        }
        return false;
    }
     ...
     *
     * <p>For two sensors hashcodes will be equal, if they have have: </p>
     *
     * <ul>
     *     <li>the same type (ie. the same subclass of DemoSensor)</li>
     *     <li>the same threshold value</li>
    ...
    public int hashCode() {
        ...
        result = HASH_CODE_SCALE * result + Arrays.hashCode(data);
        return result;
    }
}